...
This page details the protocol implemented for syscoin device app. Since this code is a fork of https://github.com/LedgerHQ/app-bitcoin-new, it uses the same protocols. It is the same as the one used since version 2.1.0 of the bitcoin app.
...
Get a receive or change an address for a registered or default wallet, after validating it with the user using the trusted screen.
...
- the magic string `"\x18Syscoin Signed Message:\n"` (equal to `18537973636f696e205369676e6564204d6573736167653a0a` in hexadecimal)
